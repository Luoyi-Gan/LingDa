// lib/api.js
// ==========================================================
// 后端 API 客户端 —— 移植自小程序 utils/api.js
//   wx.request        -> axios
//   wx.getStorageSync -> localStorage(经 auth.js)
//   wx.showToast      -> bridge.toast
//   wx.reLaunch(登录) -> bridge.navigate('/login')
// 保留原行为：
