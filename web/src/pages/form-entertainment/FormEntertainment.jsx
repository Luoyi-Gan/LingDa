// UI 重做 Phase 5：FormEntertainment —— t-violet 主调 + Bento 重写
  ...
  return (
    <div className="relative min-h-screen pb-32 md:pb-12">
      ...
      <div className="relative mx-auto w-full max-w-[860px] px-4 pt-4 md:px-8 md:pt-6">
        {/* Hero —— t-violet + Sparkles 简笔 */}
        <Card bento className="t-violet border-transparent p-6 md:p-7 relative overflow-hidden mb-4">
          <Sparkles aria-hidden className="absolute -right-8 -bottom-8 h-44 w-44 opacity-15" strokeWidth={1.25} />
          <div className="relative">
            <p className="text-[10px] font-bold uppercase tracking-[0.18em] opacity-70">Entertainment</p>
