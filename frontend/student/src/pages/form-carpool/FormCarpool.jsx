    ...
    <div className="relative min-h-screen bg-[#F7F9FC] pb-32 md:pb-12">
      ...
      <div className="relative mx-auto w-full max-w-[860px] px-4 pt-4 md:px-8 md:pt-6">
        <Card bento className="relative mb-4 overflow-hidden border-slate-200 bg-white p-5 shadow-sm md:p-6">
          <div className="absolute right-5 top-5 hidden h-12 w-12 items-center justify-center rounded-lg bg-blue-50 text-blue-700 md:flex">
            <Car aria-hidden className="h-6 w-6" strokeWidth={2} />
          </div>
          <div className="relative">
            <p className="text-xs font-semibold uppercase tracking-[0.18em] text-slate-400">Carpool</p>
